...
class EntityEditorExample extends React.Component {
  constructor(props) {
    ...
    // const blocks = convertFromRaw(rawContents);
...
//ReactDOM.render(<EntityEditorExample />, document.getElementById('container'));
ReactDOM.render(<CharacterWordSentence />, document.getElementById('root'));
